  ...
  const options = {
    definition: {
      ...
      info: {
        ...
        description:
          'Foundation API for authentication, tenant context, subscription lifecycle management, operator administration, and marketplace webhooks.'
      },
      servers: [
        {
          url: '/'
