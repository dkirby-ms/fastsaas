  ...
  return (
    <section className="space-y-6">
      <header className="rounded-3xl border border-slate-200 bg-white px-6 py-6 shadow-panel">
        ...
        <h2 className="mt-3 text-2xl font-semibold text-slate-950">Listing images and trailers</h2>
        <p className="mt-3 max-w-3xl text-sm text-slate-500">Review the image gallery and embedded trailers currently synced from Partner Center.</p>
      </header>

      <section className="space-y-4">
        <div>
          <h3 className="text-xl font-semibold text-slate-950">Asset gallery</h3>
          <p className="mt-2 text-sm text-slate-500">Screenshots, logos, and thumbnails appear here in their synced display order.</p>
        </div>
      ...
      <section className="space-y-4">
        <div>
          <h3 className="text-xl font-semibold text-slate-950">Trailers</h3>
          <p className="mt-2 text-sm text-slate-500">Embedded marketplace trailers and demo videos for this product.</p>
        </div>

        {assetsQuery.data.trailers.length === 0 ? (
          <div className="rounded-3xl border border-dashed border-slate-300 bg-slate-50 px-6 py-12 text-center text-sm text-slate-500">No trailers synced yet.</div>
        ) : (
