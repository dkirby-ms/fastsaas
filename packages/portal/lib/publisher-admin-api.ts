...
export const publisherAdminContracts = [
  ...
  { method: 'GET', path: publisherAdminPaths.products, label: 'Marketplace product list' },
  { method: 'GET', path: '/v1/publisher/products/:productId', label: 'Marketplace product detail' },
  { method: 'GET', path: '/v1/publisher/products/:productId/assets', label: 'Listing assets and trailers' },
  { method: 'GET', path: '/v1/publisher/products/:productId/audiences', label: 'Preview and private audiences' },
  { method: 'GET', path: '/v1/publisher/products/:productId/plans/:planId/pricing', label: 'Plan pricing visibility' },
