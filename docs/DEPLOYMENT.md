# FastSaaS Deployment Guide

This guide covers deploying FastSaaS to Azure Container Apps with automated infrastructure provisioning via Bicep and GitHub Actions.
...
FastSaaS uses a two-phase Bicep deployment approach:

**Phase 1: Infrastructure Deployment**
- Provisions shared infrastructure (PostgreSQL, Redis, Container Registry, etc.)
- Does NOT deploy Container Apps (set `deployContainerApps=false`)
- Run this once to bootstrap resources
