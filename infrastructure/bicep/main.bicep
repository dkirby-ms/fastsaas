...
resource redisResource 'Microsoft.Cache/redisEnterprise@2025-04-01' existing = {
  name: redisName
}

resource redisDatabaseResource 'Microsoft.Cache/redisEnterprise/databases@2025-04-01' existing = {
